package com.company.springboot.elasticsearch.springbootelasticsearchapplication;
...
public class ElasticSearchQuery {
    ...
    public  List<Product> searchAllDocuments() throws IOException {
        ...
        SearchResponse searchResponse =  elasticsearchClient.search(s -> s.index(indexName), Product.class);
